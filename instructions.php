...
$instruction = selectOne(
    "SELECT creator, title, description, username, code, created_time FROM instructions
    ...
    <div class="instructionContainer">
        ...
        <div class="instructionsControls">
            <div class="instructionsInfo">
                <div class='instructionsTitle flex'>
                    <h2>Titel:&nbsp;</h2>
                    <h2> <?= $instruction['title']; ?></h2>
                </div>

                <div class="instructionsTime flex">
                    <!--created time-->
                    <h3>Gemaakt op:&nbsp;</h3>
                    <h3> <?= $instruction['created_time']; ?></h3>
                </div>

                <div class="instructionsCreator flex">
                    <!--creator info-->
                    <h3>Gemaakt door:&nbsp;</h3>
                    <h3> <?= $instruction['username']; ?></h3>
                </div>

                <div class="infoDetails flex">
                    <!--instruction details-->
                    <p>Beschrijving:&nbsp;</p>
            ...
            <div class="controls">
                ...
                <div class="remove">
                    ...
                    if ($isAdmin || $isLocalSuperuser):
                        ?>
                        <button class="btn" onclick="changeUser()"><p>verander gemachtigde gebruiker</p></button>
                    ...
                    if ($isAdmin || $isLocalSuperuser):
                        ?>
                        <button class="btn btn_remove" onclick="confirm()">Verwijder Instructies</button>
                    ...
                    ?>
                    <button class="btn" onclick="openqr()">genereer QRcode</button>
                </div>

                <div class="remove" id="qrBlock" style="display: none;">
                    <img src="data:image/png;base64, <?= $instruction['code'] ?>" id="QRimage" alt="">
                    <button class="btn" id=download onclick="downloadQR()">Download</button>
                </div>
            </div>
        </div>
